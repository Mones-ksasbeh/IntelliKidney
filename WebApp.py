    ...
    st.markdown(
        ...
        <div class="author-container">
            <div class="author-card"> 
                ...
                <p style="font-size: 14px; color: #555; margin-top: 20px; margin-bottom: 5px; line-height: 1.2;">Data Science Graduate from Al Albayt University <br> Interested in Deep Learning, Machine Learning<br> & Data Engineering <br>Certified by IBM & Alteryx </p>
