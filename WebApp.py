    ...
    st.markdown(
        ...
        <style>
            .author-container {
                ...
                gap: 180px; /* Increased space between cards */
                margin-top: 20px;
                flex-wrap: wrap;
            }
            .author-card {
        ...
        <div class="author-container">
            <div class="author-card"> 
                ...
                <p style="font-size: 14px; color: #555; margin-top: 20px; margin-bottom: 5px; line-height: 1.2;">Data Science Graduate from Al Albayt University <br> Interested in Deep Learning, Machine Learning<br> & Data Engineering <br> Skilled in Python, SQL, <br>Power BI, and Alteryx <br>| Certified by IBM & Alteryx </p>
