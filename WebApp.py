...
# If the Option Explainable AI (XAI)
    ...
    # Use a subset of data for background (for faster computation)
    background = shap.sample(Data, 100)  # Sample 100 instances

    # Create SHAP KernelExplainer
    explainer = shap.KernelExplainer(ada_model.predict_proba, background)
    
    # Calculate SHAP values for a specific instance (e.g., first instance in the dataset)
    instance = Data.iloc[0:1]  # Replace with the instance you want to explain
