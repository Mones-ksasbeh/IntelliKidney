    ...
    if st.button("Predict"):
        ...
        if any(field == '' or field == 0 for field in required_fields):
            ...
            if prediction[0] == 1:
                ...
                st.markdown("<h6 style='font-family: Times New Roman;'>The model has assessed the patient's data and found no significant likelihood of Chronic Kidney Disease (CKD).\nBelow is a breakdown of the top 3 features contributing to this diagnosis, along with their relative impact and clinical significance.</h5>", unsafe_allow_html=True)
                st.markdown(explanation_markdown)
